...
var require_gif = __commonJS((exports, module) => {
  (function(f) {
...
async function screenshot() {
  let canvas = await import_html2canvas.default(currentFrameDiv, {
...
var renderAction = function(i) {
  ...
  clone.addEventListener("click", (e) => {
    ...
    frameListFrames.splice(i, 0, frameListFrames[i].cloneNode(true));
    updateShownFrame(editingFrameIndex);
  });
...
var actionsToSH = function() {
  ...
  for (let action of actions) {
    if (action.type === "frame") {
      ...
      result += "sleep " + frameDelay * action.frames / 1000 + "\n";
      result += 'echo -e "\\033[H"\n';
    }
  }
...
var renderingPopup = document.createElement("div");
...
var renderingProgress = document.createElement("progress");
renderingProgress.max = 100;
renderingProgress.value = 0;
renderingPopup.appendChild(renderingProgress);
var renderingPreview = document.createElement("img");
...
var loadTextanim = document.createElement("button");
...
var downloadSH = document.createElement("button");
